...
num = ['back_from_scrimmage', 'min_dist', 'max_dist', 'mean_dist', 'std_dist',
       ...
       'Y', 'S', 'A', 'Dis', 'Orientation', 'Dir', 'YardLine','Diff_Score']
num = num + ['X_qb','Y_qb','S_qb','A_qb','Dis_qb','Orientation_qb','Dir_qb']
...
num_2 = ['X','Y', 'S', 'A', 'Dis', 'Orientation', 'Dir'] + ['X_qb','Y_qb','S_qb','A_qb','Dis_qb','Orientation_qb','Dir_qb']
