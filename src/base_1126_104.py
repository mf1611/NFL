...
def create_features(df, deploy=False):
    ...
    basetable['def_X_std_rate'] = basetable['def_X_std'] / basetable['X_std']
    basetable['def_Y_std_rate'] = basetable['def_Y_std'] / basetable['Y_std']
    basetable['off_X_std_rate'] = basetable['off_X_std'] / basetable['X_std']
    basetable['off_Y_std_rate'] = basetable['off_Y_std'] / basetable['Y_std']
    basetable['off_Y_std_rate'] = basetable['off_Y_std'] / basetable['Y_std']

    basetable['off_def_X_std_rate'] = basetable['off_X_std'] / basetable['def_X_std']
    basetable['off_def_Y_std_rate'] = basetable['off_Y_std'] / basetable['def_Y_std']
