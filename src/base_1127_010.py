...
del train_basetable_2,train_basetable_3,train_basetable_4,train_basetable_5,train_basetable_6
gc.collect()
...
if  TRAIN_OFFLINE==False:
    ...
    for (test_df, sample_prediction_df) in tqdm(iter_test):
        ...
        basetable_5 = create_features_5(test_df, deploy=True)
        basetable_6 = create_features_6(test_df, deploy=True)
        ...
        basetable = pd.merge(basetable, basetable_5, on=['GameId','PlayId'])
        basetable = pd.merge(basetable, basetable_6, on=['GameId','PlayId'])
