...
cols_1 = [col for col in train_basetable.columns if col not in ['GameId','PlayId']]
...
#     lookahead.inject(model) # add into model
    ...
    model.fit([x_tr[cols_1],x_tr[cols_2],x_tr[cols_3],x_tr[cols_4]], y_tr,callbacks=[CRPSCallback(validation = (x_val,y_val)),es,mc], epochs=100, batch_size=bsz,verbose=False)
