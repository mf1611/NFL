...
def create_features(df, deploy=False):
    ...
    # # 特徴量作成
    basetable['mean_rate'] = basetable['def_mean_dist'] / basetable['off_mean_dist']
    basetable['def_mean_std'] = basetable['def_mean_dist'] / basetable['def_std_dist']
    basetable['off_mean_std'] = basetable['off_mean_dist'] / basetable['off_std_dist']
    basetable['def_mean_off_std'] = basetable['def_mean_dist'] / basetable['off_std_dist']
    basetable['off_mean_def_std'] = basetable['off_mean_dist'] / basetable['def_std_dist']
...
num += ['dist_between_def_off']

num += ['mean_rate','def_mean_std','off_mean_std','def_mean_off_std','off_mean_def_std']
