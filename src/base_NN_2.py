...
def model_396_1():
    ...
    emb = Concatenate()(embedding_list)
    emb = Dense(256, activation='relu')(emb)
    emb = Dense(128, activation='relu')(emb)

    x_1 = Dense(1024, activation='relu')(input_numeric_1)
    x_1 = Dense(512, activation='relu')(x_1)

    x_2 = Dense(512, activation='relu')(input_numeric_2)
    x_2 = Dense(256, activation='relu')(x_2)


    x = Concatenate()([emb, x_1, x_2])
