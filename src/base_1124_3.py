...
def add_features(df):
    ...
    df_summary = df[df['Team'] != df['RusherTeam']].groupby(['GameId','PlayId'])\
                        .agg({
                            'dist_from_rusher':['min','max','median','std'],
                            'X': ['median'],
                            'Y': ['median']
                        })\
                        .reset_index()
...
def create_features(df, deploy=False):
    ...
    ###########
    #basetable['off_def_mean_rate'] = basetable['off_mean_dist'] / basetable['def_mean_dist']
    #basetable['off_def_mean_rate'] = basetable['off_mean_dist'] / basetable['def_std_dist']
