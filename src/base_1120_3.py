...
def add_features(df):
    ...
    df_summary = df[df['Team'] != df['RusherTeam']].groupby(['GameId','PlayId'])\
                        ...
                        .reset_index()
    df_summary.columns = ['GameId','PlayId','def_min_dist','def_max_dist','def_mean_dist','def_std_dist']
...
num = ['back_from_scrimmage', 'X',
       'Y', 'S', 'A', 'Dis', 'Orientation', 'Dir', 'YardLine']

num += ['def0_min_dist','def0_max_dist','def0_mean_dist','def0_std_dist','def0_Dir_mean','def1_min_dist','def1_max_dist','def1_mean_dist','def1_std_dist','def1_Dir_mean',
'off0_min_dist','off0_max_dist','off0_mean_dist','off0_std_dist','off0_Dir_mean','off1_min_dist','off1_max_dist','off1_mean_dist','off1_std_dist','off1_Dir_mean']

num += ['cos_sim_def0','cos_sim_def1','cos_sim_off0','cos_sim_off1']

# num += ['defG_X_mean','defG_X_std','defG_Y_mean','defG_Y_std','defG_S_mean','defG_A_mean','defG_Dir_mean']
# num += ['cos_sim','cos_sim_cross_S','cos_sim_cross_A']
...
def model_NN():
    ...
    # input_env1 = Input(shape=(len(env1),))
    # inputs.append(input_env1)
    # embedding_env1 = Dense(5, activation='relu')(input_env1)
    # embeddings.append(embedding_env1)

    # input_env2 = Input(shape=(len(env2),))
    # inputs.append(input_env2)
    # embedding_env2 = Dense(5, activation='relu')(input_env2)
    # embeddings.append(embedding_env2)
