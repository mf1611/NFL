...
def create_features(df, deploy=False):
    ...
    basetable['def_std_off_std'] = basetable['def_std_dist'] / basetable['off_std_dist']
    basetable['def_std_tot_std'] = basetable['def_std_dist'] / basetable['std_dist']
    basetable['off_std_tot_std'] = basetable['off_std_dist'] / basetable['std_dist']

    # # 際際かそうでないかの特徴
    # basetable['class_Yardline'] = 0
    # basetable.loc[basetable['YardLine']<10, 'class_Yardline'] = 1
    # basetable.loc[(basetable['YardLine']>=10) & (basetable['YardLine']<30), 'class_Yardline'] = 2
    # basetable.loc[(basetable['YardLine']>=30) & (basetable['YardLine']<50), 'class_Yardline'] = 3
    # basetable.loc[(basetable['YardLine']>=50) & (basetable['YardLine']<80), 'class_Yardline'] = 4
    # basetable.loc[basetable['YardLine']>=80, 'class_Yardline'] = 5
...
num += ['def_std_off_std', 'def_std_tot_std','off_std_tot_std']
